        ...
        methods: {
            ...
            setUrl : function () {
                var content = "单号：__________" +
                                ...
                                "<br>身份证号：______" +
                                "<br><br>丙方（服务商）：成都朴素科技有限公司（“欢喜财富”平台运营商）客服电话：_______" +
                                "<br><br>　　甲乙双方均系丙方“欢喜财富”平台已注册的实名用户，同意并自愿遵守丙方提供的《用户注册协议》及其他平台操作准则，现基于平等、自愿、诚信的原则，就借贷相关事宜达成如下约定：" +
                                "<br><br>　　一、借款内容" +
                                ...
                                "<br><br>　　七、其他" +
                                "<br><br>　　丙方作为网络借贷信息中介服务商，见证甲乙双方本次借款协议的签订，但无法保证甲乙双方的实际履约能力，也依法不对本协议线下的支付、催收提供任何承诺和服务。本借款协议留存于欢喜财富平台，甲乙双方可按照用户《用户注册协议》进行相应操作。" +
                                "<br><br>　　甲方：______" +
                                "<br>　　_____年______月____日" +
                                "<br><br>　　服务商：成都朴素科技有限公司" +
                                "<br>　　_____年______月____日"
                        ;
